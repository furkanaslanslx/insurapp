...
class InnerDrawerView extends StatelessWidget {
  const InnerDrawerView({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer2<InnerDrawerProvider, ThemeNotifier>(
      builder: (context, drawerProvider, themeNotifier, child) {
        return ZoomDrawer(
          controller: innerDrawerController,
          style: DrawerStyle.defaultStyle,
          menuScreen: const InnerMenuScreen(),
...
class InnerMenuScreen extends StatelessWidget {
  const InnerMenuScreen({super.key});
